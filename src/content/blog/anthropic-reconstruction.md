...
description: "Anthropic's Claude cybersecurity evaluations breached real systems due to a configuration error. Applying responsibility reconstruction reveals why technical failure is not a governance finding."
metaDescription: "Applying responsibility reconstruction to Anthropic's Claude evals shows why a technical configuration error is not a completed governance finding."
...
That account explains the mechanism of failure. It does not establish responsibility for the decisions that produced it.
...
Who designed the containment structure?

Who was responsible for verifying that internet access was unavailable?

Who approved an instruction stating that no internet access existed without independently validating that condition?

Who owned real-time monitoring?

Who had authority to interrupt the evaluations?

Who approved running the models without the safeguards applied to generally available products?

Who authorized 141,006 evaluation runs to proceed under a control structure that had not been verified against external access?

Who accepted the risk that nonconsenting third parties could become involuntary participants in Anthropic's capability testing?
